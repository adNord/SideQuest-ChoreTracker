...
public class TaskController {
    ...
    @GetMapping
    public ResponseEntity<Object> getAllTasksForHousehold(Authentication authentication) {
        return taskService.getAllTasksForUserHousehold(getUserId(authentication));
    }

    @DeleteMapping("/{taskId}")
    public ResponseEntity<Object> deleteTask(@PathVariable String taskId, Authentication authentication) {
        String userId = getUserId(authentication);
